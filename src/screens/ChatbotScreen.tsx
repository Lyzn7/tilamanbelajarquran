    ...
    >
      ...
      >
        ...
        <View
          style={[
            styles.limitBadge,
            { backgroundColor: colors.badge, borderColor: colors.border },
          ]}
        >
          <Ionicons
            name="chatbubble-ellipses"
            size={12}
            color={remaining > 0 ? colors.primary : colors.muted}
          />
          <Text
            style={[
              styles.limitText,
      ...
      >
        ...
        <FlatList
          ...
          ListFooterComponent={
            isLoading ? <TypingIndicator color={colors.primary} /> : null
          }
        ...
        >
          ...
          <Text style={[styles.disclaimerText, { color: colors.muted }]}>
            AI dapat membuat kesalahan. Pendapat ulama &amp; fatwa resmi lebih
            diutamakan. Selalu verifikasi ke ustadz terpercaya.
          </Text>
        </View>
          ...
          >
            ...
            <Pressable
              style={[
                ...
                {
                  backgroundColor:
                    input.trim() && !isLoading ? colors.primary : colors.badge,
                },
              ]}
              onPress={sendMessage}
